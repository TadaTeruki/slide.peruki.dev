...
- ${\overleftarrow{h}}_b(t)$: 後ろ向き層 (未来から過去へ伝播)

の2つの隠れ状態を結合した${h}(t)$を用いて
$$ {y}(t) = g({V}{h}(t) + {c}) $$

*${h}(t)$ は単にベクトルを並べて作ることが多いが、${h}(t) = {h}_f(t) + {h}_b(t)$とすることもある*
...
*文脈依存の場合など、学習パラメータとして埋め込み行列を用いることもある*
...
x(3) &= \begin{pmatrix} 0 \\ 0 \\ 1 \\ 0 \end{pmatrix}, &
